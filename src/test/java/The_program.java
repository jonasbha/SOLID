...
public class The_program {
    ...
    public void sums_numbers_and_grand_total() throws IOException {
        String expected =
            ...
            "1205 + 795 = 2000\n" +
            "Total: 2020\n";
        String actual = new CalculatorProgram(new ExpressionParser(new ExpressionReader()))
    ...
    public void subtracts_numbers() throws IOException {
        String expected =
            ...
            "1205 - 795 = 410\n" +
            "Total: -404\n";
        String actual = new SubtractionProgram(new ExpressionParser(new ExpressionReader()))
            .readParseCalculateAndFormat()
            .toString();
        assertEquals(expected, actual);
    }
